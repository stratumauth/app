...
namespace Stratum.Droid.Shared
{
    ...
    {
        public static readonly IReadOnlyDictionary<string, int> Service = new Dictionary<string, int>(771)
        {
        ...
        public static readonly IReadOnlyDictionary<string, int> ServiceDark = new Dictionary<string, int>(229)
        {
